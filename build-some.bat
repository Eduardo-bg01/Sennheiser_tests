...
REM Build selected projects (audio test + functional button test + support tools)
...
copy /Y "%ROOT%run-some.bat" "%BIN_DIR%\run-some.bat" >nul
...
echo Run tests with: %BIN_DIR%\run-some.bat
exit /b 0
